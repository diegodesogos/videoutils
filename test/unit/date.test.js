...
test('Date Utils - formatFfmpegDate formats legacy EXIF date correctly', () => {
    assert.strictEqual(formatFfmpegDate('2003:08:02 10:40:48'), '2003-08-02T10:40:48');
...
test('Date Utils - extractDateFromFilename handles time separated by dashes', () => {
    ...
    assert.strictEqual(res.iso, '2011-11-05T11:40:32');
});

test('Date Utils - extractDateFromFilename handles date and time separated by space', () => {
    const res = extractDateFromFilename('2013-01-19 120718- Vacaciones Costa del Este003 7');
    assert.strictEqual(res.iso, '2013-01-19T12:07:18');
});
